...
<div class="grid-3 mb-24">
<div class="glass-card" style="text-align:center"><div class="avatar" style="background:var(--gradient-1);width:56px;height:56px;font-size:20px;margin:0 auto 12px">RK</div><div class="font-bold">Rajesh Kumar</div><div class="text-xs text-muted mb-8">rajesh@lekha.in</div><span class="badge badge-purple">Owner</span><div class="text-xs text-muted mt-12"><i class="fas fa-clock"></i> Active now</div></div>
<div class="glass-card" style="text-align:center"><div class="avatar" style="background:var(--gradient-2);width:56px;height:56px;font-size:20px;margin:0 auto 12px">PM</div><div class="font-bold">Pooja M.</div><div class="text-xs text-muted mb-8">pooja@lekha.in</div><span class="badge badge-info">Manager</span><div class="text-xs text-muted mt-12"><i class="fas fa-clock"></i> 2h ago</div></div>
<div class="glass-card" style="text-align:center"><div class="avatar" style="background:var(--gradient-3);width:56px;height:56px;font-size:20px;margin:0 auto 12px">AK</div><div class="font-bold">Arun K.</div><div class="text-xs text-muted mb-8">arun@lekha.in</div><span class="badge badge-success">Staff</span><div class="text-xs text-muted mt-12"><i class="fas fa-clock"></i> 5h ago</div></div>
</div>
